...
def resource_path(relative_path):
    """دالة لجلب المسار الصحيح للملفات الملحقة عند التشغيل كملف تنفيذي (.exe)"""
    try:
...
# استيراد المحركات مع معالجة الأخطاء لضمان استقرار البناء
try:
    ...
    # في حال فشل الاستيراد المباشر (مثل تشغيل ملف exe)
    # نقوم بإضافة المسار الحالي للمسارات للبحث عن الملفات
...
class TSPToolPro(ctk.CTk):
    ...
    def check_for_updates_silent(self):
        ...
        try:
            ...
            pass # منع الانهيار في حال فشل الاتصال بالسيرفر
